...
# 页面配置
st.set_page_config(
    page_title="Physical-Mental Comorbidity Risk Assessment Model in China",
    page_icon="🩺",
    layout="wide"
)
...
# 训练模型使用的特征（顺序必须与训练一致）
FEATURES = [
    "self_rate_health", "pain", "adl", "age",
    "score","BMI", "eyesight_long", "marriage"
]
...
FEATURE_LABELS = {
    ...
    "eyesight_long": "Distance vision",
    "marriage": "Marital status",
}

# 字段说明（侧栏说明文字）
FEATURE_DESC = {
    "self_rate_health": "Likert 1–5: Very Good/Good/Fair/Poor/Very poor (encoded 1–5)",
    "pain": "0/1 map to No/Yes",
    "adl": "0/1 map to No/Yes (any ADLs)",
    "age": "Age (Range from 50-108)",
    ...
    "eyesight_long": "0/1 map to Normal/Poor",
...
LIKERT5_FMT = lambda x: {1: "Very poor", 2: "Poor", 3: "Fair", 4: "Good", 5: "Very Good"}[x]

EYE_OPTIONS = [0, 1]
EYE_FMT = lambda x: "Normal" if x == 0 else "Poor"
...
def main():
    ...
    # 页面标题与说明
    st.title("Physical-Mental Comorbidity Risk Assessment Model in China")
    ...
    if st.button("Predict"):
        ...
        row = [
            self_rate_health, pain, adl, age,
            score_norm, BMI, eyesight_long, marriage
        ]
        ...
        st.markdown(
            ...
            "we recommend that the optimal threshold value be set at 26.166%.  \n"
